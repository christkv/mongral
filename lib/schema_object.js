...
var buildSchemaObject = function(schema_name, rules, schema) {
	...
	var SchemaObject = function(values, options) {
	  ...
	  var lifecycle = options.lifecycle ? options.lifecycle : { updateStatement: {} };
	  ...
	  self.save = function(callback) {
	    ...
	    self.validate({state: state}, function(err) {
	      ...
	      if(isNew) {
	        ...
	        executeUpdate(self, values, lifecycle, _collection, options, function(err, result) {
	          if(err) return callback(err);
...
//
// Execute the update
var executeUpdate = function(self, values, lifecycle, collection, options, callback) {
  options = options || {};
